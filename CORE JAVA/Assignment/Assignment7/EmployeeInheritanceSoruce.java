...
class Test{
	...
	public static void main(String[]args) {
		...
		E1.Display();
		Employee E2 = new Employee(344,"XYZ",80000);
		E2.Display();
		
		Admin A1 = new Admin();
		A1.Display();
		Admin A2 = new Admin(111,"ABC",40000,900);
		A2.Display();
		
		HR H1 = new HR();
		H1.Display();
		HR H2 = new HR(121,"PQR",60000,700);
		H2.Display();
		
		SalesManager S1 = new  SalesManager();
		S1.Display();
		SalesManager S2 = new  SalesManager(222,"LMN",50000,600,60);
		S2.Display();
