...
public String toString(){
	return "\nUserName is:"+this.UserName+"Email is:"+this.Email+"IsPublic :"+this.IsPublic+"ISVerified is:"+this.IsVerified+"CountryOrigin is:"+this.CountryOrigin+"NoOfPost "+this.NoOfPost+"Like is:"+this.Like+"Comment is:"+this.Comment+"CreatedNoOfImpression is:"+this.CreatedNoOfImpression+"CreatedAt "+this.CreatedAt;
...
{
    return (Like + Comment + NoOfStoryArchive) / NoOfFollowers;
}
...
class Linkdien extends SocialMediaAccount{
	...
	int calculateEngagementRate()
	{
	    return (Like + Comment + NoOfProfileview) / NoOfPost;
	}
...
class TestMedia{
	public static void main (String [] args) {
		...
		//S1 = new SocialMediaAccount("KKK","k@gmail.com",true,false,"India",60,8000,500,200,"23-No-2020");
		//S1.Display();
		//S1.calculateEngagementRate();
		S1= new Instagram("lll","l@gmail.com",true,false,"India",70,9000,700,100,"01-No-2020",100,200,300,100,80,70);
		S1.Display();
		S1.calculateEngagementRate();
		S1 = new Linkdien("jjj","j@gmail.com",true,false,"India",70,9000,700,100,"01-No-2021",500,560,60);
		S1.Display();
		S1.calculateEngagementRate();
		S1 = new Youtube("VVV","v@gmail.com",true,false,"India",70,9000,700,100,"01-No-2015",100,120.00,true,40.00);
		S1.Display();
		S1.calculateEngagementRate();
